...
import mods.mca.block.BlockTombstone;
import mods.mca.command.CommandBlock;
import mods.mca.command.CommandBlockAll;
import mods.mca.command.CommandCheckUpdates;
import mods.mca.command.CommandDebugMode;
import mods.mca.command.CommandDebugRule;
import mods.mca.command.CommandDivorce;
import mods.mca.command.CommandHaveBaby;
import mods.mca.command.CommandHaveBabyAccept;
import mods.mca.command.CommandHelp;
import mods.mca.command.CommandMarry;
import mods.mca.command.CommandMarryAccept;
import mods.mca.command.CommandMarryDecline;
import mods.mca.command.CommandSetGender;
import mods.mca.command.CommandSetName;
import mods.mca.command.CommandUnblock;
import mods.mca.command.CommandUnblockAll;
import mods.mca.core.forge.CommonProxy;
import mods.mca.core.forge.ConnectionHandler;
import mods.mca.core.forge.CraftingHandler;
import mods.mca.core.forge.EventHooks;
import mods.mca.core.forge.GuiHandler;
import mods.mca.core.forge.PacketHandler;
import mods.mca.core.io.ModPropertiesManager;
...
import mods.mca.item.ItemArrangersRing;
import mods.mca.item.ItemBabyBoy;
import mods.mca.item.ItemBabyGirl;
import mods.mca.item.ItemCrown;
import mods.mca.item.ItemEggFemale;
import mods.mca.item.ItemEggMale;
import mods.mca.item.ItemEngagementRing;
import mods.mca.item.ItemHeirCrown;
import mods.mca.item.ItemKingsBoots;
import mods.mca.item.ItemKingsCoat;
import mods.mca.item.ItemKingsPants;
import mods.mca.item.ItemLostRelativeDocument;
import mods.mca.item.ItemTombstone;
import mods.mca.item.ItemVillagerEditor;
import mods.mca.item.ItemWeddingRing;
...
public class MCA
{
	...
	@SidedProxy(clientSide="mods.mca.core.forge.ClientProxy", serverSide="mods.mca.core.forge.CommonProxy")
