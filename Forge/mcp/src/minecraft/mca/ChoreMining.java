 ...
 */
public class ChoreMining extends Chore
{
	 ...
	 */
	public ChoreMining(EntityBase entity)
	{
		super(entity);
	}
	 ...
	 */
	public ChoreMining(EntityBase entity, int mode, int direction, int oreType, int distance)
	{
		super(entity);
