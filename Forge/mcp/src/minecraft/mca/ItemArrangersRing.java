...
public class ItemArrangersRing extends Item
{
	...
	{
		informationList.add(Localization.getString("information.arrangersring.line1"));
		informationList.add(Localization.getString("information.arrangersring.line2"));
		informationList.add(Localization.getString("information.arrangersring.line3"));
	}
}
