...
{
	private EntityBase villagerBeingEdited;
	 ...
	 */
	public GuiVillagerEditor(EntityBase entityBase, EntityPlayer player) 
	{
		super(player);
	...
	protected void actionPerformed(GuiButton guibutton)
	{
		...
		{
			nameTextField.setText(EntityBase.getRandomName(villagerBeingEdited.gender));
