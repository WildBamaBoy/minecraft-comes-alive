...
public class ItemEngagementRing extends Item
{
	...
	{
		informationList.add(Localization.getString("information.engagementring.line1"));
		informationList.add(Localization.getString("information.engagementring.line2"));
		informationList.add(Localization.getString("information.engagementring.line3"));
	}
}
