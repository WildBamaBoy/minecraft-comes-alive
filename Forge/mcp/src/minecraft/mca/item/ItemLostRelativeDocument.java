...
public class ItemLostRelativeDocument extends Item
{
	...
	{
		informationList.add(Localization.getString("information.lostrelativedocument.line1"));
		informationList.add(Localization.getString("information.lostrelativedocument.line2"));
	}
}
