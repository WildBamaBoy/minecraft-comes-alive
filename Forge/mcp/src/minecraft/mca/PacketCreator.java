...
public final class PacketCreator 
{
	 ...
	 */
	public static Packet createSyncPacket(EntityBase entityBase)
	{
		try
		{
			Packet250CustomPayload thePacket = new Packet250CustomPayload();
	 ...
	 */
	public static Packet createChorePacket(int entityId, Chore chore) 
	{
		try
		{
			Packet250CustomPayload thePacket = new Packet250CustomPayload();
	 ...
	 */
	public static Packet createSayLocalizedPacket(EntityPlayer player, EntityBase entity, String id, boolean useCharacterType, String prefix, String suffix)
	{
		try
		{
			Packet250CustomPayload thePacket = new Packet250CustomPayload();
	 ...
	 */
	public static Packet createVillagerPlayerProcreatePacket(EntityBase villager, EntityPlayer player, String babyGender) 
	{
		try
		{
			Packet250CustomPayload thePacket = new Packet250CustomPayload();
