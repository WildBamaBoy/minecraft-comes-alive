...
public final class Logic
{
	 ...
	 */
	public static List<Coordinates> getNearbyBlockCoordinates(EntityBase entity, int blockID, int maxDistanceAway)
	{
		List<Coordinates> CoordinatesList = new LinkedList<Coordinates>();
	 ...
	 * @return	List containing the coordinates of each block with the provided ID within the specified distance of the entity.
	 */
	public static List<Coordinates> getNearbyBlockCoordinatesWithMetadata(EntityBase entity, int blockID, int metadata, int maxDistanceAway)
	{
		List<Coordinates> CoordinatesList = new LinkedList<Coordinates>();
	 ...
	 */
	public static EntityBase getEntityWithIDWithinDistance(Entity entityReference, int id, int maxDistanceAway) 
	{
		...
		for (Entity entityNearMe : entitiesAroundMe)
		{
			if (entityNearMe instanceof EntityBase)
			{
				EntityBase entityBase = (EntityBase)entityNearMe;
	 ...
	 */
	public static float getEntityDistanceFromPlayer(EntityPlayer player, EntityBase entity)
	{
	 ...
	 */
	public static Coordinates getRandomNearbyBlockCoordinatesOfType(EntityBase entity, int blockID)
	{
	 ...
	 */
	public static ItemStack getGiftStackFromRelationship(EntityPlayer player, EntityBase entity)
	{
	 ...
	 */
	public static EntityPlayer getNearestPlayer(EntityBase entity)
	{
		double posX = entity.posX;
		double posY = entity.posY;
		double posZ = entity.posZ;
