 ...
 */
public class ChoreHunting extends Chore
{
	 ...
	 */
	public ChoreHunting(EntityBase entity)
	{
		super(entity);
	}
	 ...
	 */
	public ChoreHunting(EntityBase entity, int huntingMode) 
	{
		super(entity);
	...
	public void runChoreAI() 
	{
		...
		else
		{
			...
			if (EntityBase.getBooleanWithProbability(chanceOfDeath) == true)
			{
				if (!owner.worldObj.isRemote)
				{
