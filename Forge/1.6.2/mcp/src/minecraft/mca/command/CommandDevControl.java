	...
	public void processCommand(ICommandSender sender, String[] arguments) 
	{
		try
		{
			...
			if (commandName.equalsIgnoreCase("haltChildGrowth"))
			{
				...
				{
					sender.sendChatToPlayer(new ChatMessageComponent().func_111072_b(Constants.COLOR_GREEN + "Dev control set."));
				...
				{
					sender.sendChatToPlayer(new ChatMessageComponent().func_111072_b(Constants.COLOR_RED + "Argument must be true or false."));
				}
			}
		}
