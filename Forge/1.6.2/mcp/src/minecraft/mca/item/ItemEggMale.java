...
public class ItemEggMale extends Item
{
	...
	public static boolean spawnVillager(World world, double posX, double posY, double posZ)
	{
		...
		{
			final EntityVillagerAdult entityVillager = new EntityVillagerAdult(world, true, world.rand.nextInt(VillagerRegistryMCA.getNumberOfRegisteredVillagers() - 1));
