...
public enum EquipmentSet {
    ...
    ARCHER_0(Items.CROSSBOW, null, null, Items.LEATHER_CHESTPLATE, null, null),
    ARCHER_1(Items.CROSSBOW, null, null, Items.IRON_CHESTPLATE, Items.LEATHER_LEGGINGS, Items.LEATHER_BOOTS),
    ARCHER_2(Items.CROSSBOW, null, null, Items.DIAMOND_CHESTPLATE, Items.LEATHER_LEGGINGS, Items.IRON_BOOTS),
