...
public class PacketGift extends AbstractPacket implements IMessage, IMessageHandler<PacketGift, IMessage>
{
	...
	private boolean handleMatchmakersRing(EntityPlayer player, EntityHuman human, ItemStack stack)
	{
		...
		{
			human.say("You need two of those.", player); //TODO
		...
		{	
			if (partner == null)
			{
				human.say("There was no-one nearby.", player); //TODO
			...
			{
				human.say("I can't marry " + partner.getName() + ".", player); //TODO
			...
			{
				human.say("I will marry " + partner.getName() + ".", player); //TODO
	...
	private boolean handleEngagementRing(EntityPlayer player, EntityHuman human)
	{
		...
		{
			human.say("I am already engaged.", player); //TODO
		}
		...
		{
			human.say("We are now engaged!", player); //TODO
	...
	private boolean handleDivorcePapers(EntityPlayer player, EntityHuman human) 
	{
		...
		{
			human.say("I am not married.", player); //TODO
		}
		
		else if (human.isMarriedToAPlayer() && data.spousePermanentId.getInt() != human.getPermanentId())
		{
			human.say("I am not married to you.", player); //TODO
		}
		...
		else
		{
			if (human.isMarriedToAPlayer())
			{
				...
				human.say("We are no longer married.", player); //TODO
			...
			{
				human.say("I am no longer married to my spouse.", player); //TODO
	...
	private boolean handleStandardGift(EntityPlayer player, EntityHuman human, int slot, ItemStack stack)
	{
		...
		final int giftValue = Constants.GIFT_MAP.containsKey(queryObject) ? Constants.GIFT_MAP.get(queryObject) : -5;
