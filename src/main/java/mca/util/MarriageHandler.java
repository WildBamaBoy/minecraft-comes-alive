...
{
//	public static void startEngagement(EntityPlayer player, EntityVillagerMCA human)
//	{
...
//	}
//
//	public static void startMarriage(EntityPlayer player, EntityVillagerMCA human)
//	{
...
//		if (handleEngagement)
//		{
//			for (EntityVillagerMCA localEntity : RadixLogic.getEntitiesWithinDistance(EntityVillagerMCA.class, human, 50))
//			{
//				if (localEntity.getEntityId() != human.getEntityId())
//				{
//					PlayerMemory localMemory = localEntity.getPlayerMemory(player);
...
//	}
//
//	public static void startMarriage(EntityVillagerMCA human1, EntityVillagerMCA human2)
//	{
...
//	}
//
//	public static void endMarriage(EntityPlayer player, EntityVillagerMCA human)
//	{
...
//	}
//
//	public static void endMarriage(EntityVillagerMCA human1, EntityVillagerMCA human2)
//	{
