...
public interface BlockEntityTypesMCA {
    ...
    BlockEntityType<TombstoneBlock.Data> TOMBSTONE = register("tombstone", BlockEntityType.Builder.create(TombstoneBlock.Data::new, BlocksMCA.UPRIGHT_HEADSTONE, BlocksMCA.SLANTED_HEADSTONE, BlocksMCA.CROSS_HEADSTONE));
