...
public class ItemColoredEngagementRing extends Item
{
	private IIcon[] icons = new IIcon[2];

	public ItemColoredEngagementRing()
	{
		this.setHasSubtypes(true);
		this.setMaxDamage(0);
		this.setUnlocalizedName("ColoredEngagementRing");
		this.setTextureName("mca:ColoredEngagementRing");
		this.setCreativeTab(MCA.getCreativeTab());

		GameRegistry.registerItem(this, "ColoredEngagementRing");
	}
	...
	public void registerIcons(IIconRegister iconRegister) 
	{
		...
		icons[1] = iconRegister.registerIcon("mca:RingBottom");
	}
}
