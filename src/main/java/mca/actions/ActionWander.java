...
public class ActionWander extends AbstractAction
{
	...
	public void onUpdateServer() 
	{
		...
		if (actor.getBehavior(ActionSleep.class).getIsSleeping()) return;
		if (actor.attributes.getMovementState() == EnumMovementState.STAY) {handleWatchClosestPlayer(); return;}	//Allow looking at the player while staying.
		if (actor.attributes.getMovementState() == EnumMovementState.FOLLOW || actor.getBehaviors().isToggleActionActive()) return;
