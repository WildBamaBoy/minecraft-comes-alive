...
public class AIWorkday extends AbstractAI
{
	...
	private void getLookTarget(boolean playerOnly)
	{
		...
		final List<Entity> entitiesAroundMe = owner.worldObj.getEntitiesWithinAABB(entityClass, AxisAlignedBB.getBoundingBox(owner.posX - maxDistanceAway, owner.posY - maxDistanceAway, owner.posZ - maxDistanceAway, owner.posX + maxDistanceAway, owner.posY + maxDistanceAway, owner.posZ + maxDistanceAway));
