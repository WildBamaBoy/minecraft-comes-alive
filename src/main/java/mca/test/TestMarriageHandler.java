...
public class TestMarriageHandler 
{
	...
	public void test() throws InstantiationException 
	{
		...
		Assert.assertEquals(steve.getName(), eve.getSpouseName());
		...
		Assert.assertEquals(alex.getName(), steveData.getSpouseName());
		Assert.assertEquals(steve.getName(), alexData.getSpouseName());
