...
public enum EnumPersonality {
    ...
    public int getSuccessModifierForInteraction(EnumInteraction interaction) {
        switch (interaction) {
            ...
            case JOKE:
                return moodGroup == EnumMoodGroup.GENERAL ? 0 : moodGroup == EnumMoodGroup.PLAYFUL ? 15 : moodGroup == EnumMoodGroup.SERIOUS ? -10 : 0;
            case SHAKE_HAND:
            ...
            case HUG:
                return moodGroup == EnumMoodGroup.GENERAL ? 0 : moodGroup == EnumMoodGroup.PLAYFUL ? 10 : moodGroup == EnumMoodGroup.SERIOUS ? -10 : 0;
            case KISS:
    ...
    public int getHeartsModifierForInteraction(EnumInteraction interaction) {
        switch (interaction) {
            ...
            case FLIRT:
                return moodGroup == EnumMoodGroup.GENERAL ? 0 : moodGroup == EnumMoodGroup.PLAYFUL ? 2 : moodGroup == EnumMoodGroup.SERIOUS ? -1 : 0;
            case HUG:
