...
public class MCAScreens extends JsonDataLoader implements IdentifiableResourceReloadListener {
    private static final Identifier ID = new Identifier("mca", "screens");
    private static final Type BUTTONS_TYPE = new TypeToken<Map<String, Icon>>() {}.getType();

    private static final MCAScreens INSTANCE = new MCAScreens();
