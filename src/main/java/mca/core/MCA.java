...
@Mod(modid = MCA.ID, name = MCA.NAME, version = MCA.VERSION, dependencies = "required-after:RadixCore@[1.9-2.1.0,);required-after:Forge@[12.16.0.1887,)", acceptedMinecraftVersions = "[1.9.0]",
