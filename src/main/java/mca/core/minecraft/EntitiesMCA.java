...
public class EntitiesMCA {
    public static final EntityType<VillagerEntityMCA> VILLAGER = EntityType.Builder.<VillagerEntityMCA>of((entityType, world) -> new VillagerEntityMCA(world), EntityClassification.AMBIENT).sized(0.6F, 2.0F).build(new ResourceLocation(MCA.MOD_ID, "villager").toString());
