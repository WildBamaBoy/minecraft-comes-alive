...
public class HuntableAnimal
{
	...
	/**
	 * Constructs a new huntable animal that <b>returns an <u>item</u> when killed.</b><p>
	 * Note that you can control whether or not the animal can be killed and/or tamed. Shown in the examples below. <p>
	 * <b>Ex. a typical tameable and killable animal:</b>  
	 * <code>
	 * new HuntableAnimal(EntityPig.class, Items.porkchop, Items.carrot, 70, true, true); <p>
	 * </code>
	 * 
	 * <b>Ex: an unkillable animal that can only be tamed.</b>  
	 * <code>
	...
	/**
	 * Constructs a new huntable animal that <b>returns a <u>block</u> when killed.</b> This is used for sheep in MCA. <p>
	 * 
	 * <b>Ex:</b>  
	 * <code>
