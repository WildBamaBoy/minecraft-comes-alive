...
public class MineableOre
{
	...
	/**
	 * Constructs an ore that <b>yields an <u>item</u> when it is harvested</b>.
	 * For example, diamond ore doesn't return the diamond ore block. It returns a diamond item. <p>
	 * <b>Ex: </b>
	 * <code>
	...
	/**
	 * Constructs an ore that <b>yields a <u>block</u> when it is harvested</b>.
	 * For example, some ores return themselves when harvested, like iron. <p>
	 * <b>Ex: </b>
	 * <code>
