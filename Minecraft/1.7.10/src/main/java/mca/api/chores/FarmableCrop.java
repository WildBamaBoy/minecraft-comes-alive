...
public class FarmableCrop
{
	...
	/**
	 * Constructs a new farmable crop that <b>produces a block that returns items when harvested</b>
	 * This is the same behavior as Minecraft's melon/it breaks into individual melons when harvested. <p>
	 * Ex: <p>
	 * <code>
	...
	/**
	 * Constructs a new farmable crop that <b>produces a block that returns itself when harvested</b>.
	 * This is the same behavior as Minecraft's pumpkin/you receive the pumpkin block after harvesting. <p>
	 * Ex: <p>
	 * <code>
	...
	/**
	 * Constructs a new farmable crop that <b>does not produce another block/it grows and is harvested on the same tile</b>.
	 * This is the same behavior as Minecraft's wheat, carrots, and potatos. You will most likely be using this constructor. <p>
	 * Ex: <p>
	 * <code>
