...
public class ItemEggFemale extends Item
{
	...
	{
		itemIcon = IIconRegister.registerIcon("mca:EggFemale");
	}
	...
	public static boolean spawnVillager(World world, double posX, double posY, double posZ)
	{
		...
		{
			final EntityVillagerAdult entityVillager = new EntityVillagerAdult(world, false, VillagerRegistryMCA.getRandomVillagerEntry().professionId);
