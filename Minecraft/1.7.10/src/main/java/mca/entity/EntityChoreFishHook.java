...
//			}
			...
			Vec3 motionVector = Vec3.createVectorHelper(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
			MovingObjectPosition movingObjectPosition = this.worldObj.rayTraceBlocks(vector, motionVector);
			vector = Vec3.createVectorHelper(this.posX, this.posY, this.posZ);
			motionVector = Vec3.createVectorHelper(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
			...
			if (!this.inGround)
			{
				...
				for (int i = 0; i < endByte; ++i)
				{
					...
					AxisAlignedBB bb = AxisAlignedBB.getBoundingBox(this.boundingBox.minX, boundingBoxMinY, this.boundingBox.minZ, this.boundingBox.maxX, boundingBoxMaxY, this.boundingBox.maxZ);
