...
public class RenderHuman extends RenderBiped
{
	...
	protected boolean canRenderNameTag(EntityLivingBase entityRendering)
	{
		...
		final Vec3 entityLookVector = Vec3.createVectorHelper(entityRendering.posX - entityPlayer.posX, entityRendering.boundingBox.minY + (double)entityRendering.height / 2.0F - entityPlayer.posY + (double)entityPlayer.getEyeHeight(), entityRendering.posZ - entityPlayer.posZ).normalize();
