package com.adgdev.elemental_magic.content.blocks;
...
public class IceBlock extends Block {
	...
	{
		blockIcon = p_149651_1_.registerIcon(EM.MODID + ":" + "iceBlock");
	}
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (p_149674_1_.getSavedLightValue(EnumSkyBlock.Block, p_149674_2_, p_149674_3_, p_149674_4_) > 11 - this.getLightOpacity())
        {
            ...
            if(p_149674_1_.getBlock(p_149674_2_ + 1, p_149674_3_, p_149674_4_) == Block.blockRegistry.getObjectById(8) || p_149674_1_.getBlock(p_149674_2_ + 1, p_149674_3_, p_149674_4_) == Block.blockRegistry.getObjectById(9))
            {
            	p_149674_1_.setBlock(p_149674_2_ + 1, p_149674_3_, p_149674_4_, EM.iceBlock);
            }
            ...
            if(p_149674_1_.getBlock(p_149674_2_, p_149674_3_, p_149674_4_ + 1) == Block.blockRegistry.getObjectById(8) || p_149674_1_.getBlock(p_149674_2_, p_149674_3_, p_149674_4_ + 1) == Block.blockRegistry.getObjectById(9))
            {
            	p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_ + 1, EM.iceBlock);
            }
            ...
            if(p_149674_1_.getBlock(p_149674_2_ + 1, p_149674_3_, p_149674_4_ + 1) == Block.blockRegistry.getObjectById(8) || p_149674_1_.getBlock(p_149674_2_ + 1, p_149674_3_, p_149674_4_ + 1) == Block.blockRegistry.getObjectById(9))
            {
            	p_149674_1_.setBlock(p_149674_2_ + 1, p_149674_3_, p_149674_4_ + 1, EM.iceBlock);
            }
